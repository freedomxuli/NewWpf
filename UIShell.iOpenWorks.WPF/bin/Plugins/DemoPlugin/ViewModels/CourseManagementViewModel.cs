...
namespace DemoPlugin.ViewModels
{
    public class CourseManagementViewModel : ListViewModelBase
    {
        ...
        public override void Add()
        {
            ...
            // 显示侧边框
            BundleActivator.MainWindowService.ShowSidebar(addOrEditUserControl, 300, "添加数据");
        ...
        public override void Edit()
        {
            ...
            {
                ModernDialog.ShowMessage("请选择一个数据。", "操作警告", MessageBoxButton.OK);
                return;
            }
            var addOrEditUserControl = new AddOrEditCourseUserControl();
            var addOrEditViewModel = (addOrEditUserControl.DataContext as AddOrEditCourseViewModel);
            ...
            // 显示侧边框
            BundleActivator.MainWindowService.ShowSidebar(addOrEditUserControl, 300, "编辑数据");
        ...
        public override void Delete()
        {
            ...
            if (ModernDialog.ShowMessage("确定删除当前数据？", "删除警告", MessageBoxButton.YesNo) == MessageBoxResult.Yes)
            {
